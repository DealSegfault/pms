...
export function buildOrderIntentLifecycleEvent({
    ...
    orderRole = 'UNKNOWN',
    strategySessionId = '',
    parentStrategySessionId = '',
    rootStrategySessionId = '',
    ...
    return {
        ...
        parent_strategy_session_id: parentStrategySessionId,
        root_strategy_session_id: rootStrategySessionId,
        replaces_client_order_id: replacesClientOrderId,
        user_id: userId,
